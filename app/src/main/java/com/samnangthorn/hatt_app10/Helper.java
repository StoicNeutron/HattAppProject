...
/*
Storing necessary data and func.
 */
public class Helper {
    ...
    // Public
    public static TimeZone timeZone;// ex:
    public static String currentDate = "";// ex:
    public static String timeString = "";// ex:
    public static String currentDayNameString = "";// ex:
    public static String subDate = "";// ex:
    public static String currentYear = "99";// ex:
    public static String currentMonth = "MONTH";// ex:

    public static Timer timer, timer2;
    public static TimerTask timerTask, timerTask2;
    public static double time = 0.0;
    public static double time2 = 60.0;
